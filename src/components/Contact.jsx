...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Phone, label: 'Phone', value: '+91 90253 70797', href: 'tel:+919025370797' },
    { icon: Mail, label: 'Email', value: 'info.samseetech@gmail.com', href: 'mailto:info.samseetech@gmail.com' },
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            {/* Map */}
            <div className="rounded-2xl overflow-hidden border border-white/[0.08] shadow-xl h-72">
              <iframe
